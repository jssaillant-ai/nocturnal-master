...
async function sendEmail(to, subject, htmlContent) {
    ...
    // Si SendGrid configuré, utiliser API
...
// Test webhook - SIMPLIFIÉ SANS RECURSION
...
ensureDataDir().then(() => {
    app.listen(PORT, () => {
        console.log('============================================');
        console.log('🌙 NOCTURNAL MASTER V3 FIXED');
        console.log('============================================');
        console.log(`✅ Server running on port ${PORT}`);
        console.log(`🔧 Admin Key: ${ADMIN_KEY}`);
        console.log(`💎 Free Credits: 50 per new user`);
        console.log(`🎯 Gumroad Webhook: /api/gumroad/webhook`);
        console.log(`📧 Email: ${process.env.SENDGRID_API_KEY ? 'Configured' : 'Logs only'}`);
        console.log(`⚡ Status: READY - NO RECURSION BUG`);
        console.log('============================================');
    });
});
